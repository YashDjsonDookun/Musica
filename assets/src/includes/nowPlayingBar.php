...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#nowPlayingBarContainer").on("mouseown touchstart mousemove touchmove", function(e) {
           e.preventDefault();
        });
    ...
    function setTrack(trackId, newPlaylist, play) {
        ...
        pauseSong();
        $.post("assets/src/includes/handlers/ajax/getSongJson.php", { songId: trackId }, function(data) {
            let track = JSON.parse(data);
            $(".trackName span").text(track.title);

            $.post("assets/src/includes/handlers/ajax/getArtistJson.php", { artistId: track.artist }, function(data) {
                let artist = JSON.parse(data);
                $(".artistName span").text(artist.name);
                $(".artistName span").attr("onclick", "openPage('artist.php?id="+ artist.id +"')");
            });

            $.post("assets/src/includes/handlers/ajax/getAlbumJson.php", { albumId: track.album }, function(data) {
    ...
    function playSong() {
        ...
        {
            $.post("assets/src/includes/handlers/ajax/updatePlays.php", { songId: audioElement.currentlyPlaying.id });
        }
